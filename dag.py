...
clean_data = BashOperator(
    ...
    bash_command="spark-submit --master yarn --deploy-mode cluster --jars clean.jar --class Clean.main",
    dag=dag
)
...
transform_data = BashOperator(
    ...
    # TODO : compléter le spark submit
    bash_command=f"spark-submit --master yarn --deploy-mode cluster --jars clean.jar --class Jointure.main",
    dag=dag
)
